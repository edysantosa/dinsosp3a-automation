        ...
        spawnPromise('/home/edy/dinsosp3a-automation/env/bin/python /home/edy/dinsosp3a-automation/download_agenda.py').then(
            data => {
                ...
                setTimeout( () => {
                    ...
                    spawnPromise('/home/edy/dinsosp3a-automation/env/bin/python /home/edy/dinsosp3a-automation/send_whatsapp.py', [`--groupname "${grupDinas}"`, `--message "${pesan} {date}"`, '--deletefile']).then(
